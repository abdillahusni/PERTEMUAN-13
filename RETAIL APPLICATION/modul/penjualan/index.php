...
<div class="row justify-content-center mt-3">
    <div class="col-7 bg-light-subtle me-3 p-3 shadow-sm">
        ...
        <div class="d-flex justify-content-end">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalBayar"></button>
            <!-- buat modal -->
             <div class="modal fade" id="modalBayar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-tittle fs-5" id="exampleModalLabel">Bayar</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="simpanPenjualan()">Proses</buttton>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-4 bg-ligth-subtle p-3 shadow-sm">
    <div class="mb-3">
